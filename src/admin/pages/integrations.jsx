...
import companyLogo1 from "/img-admin/company-logo-1.jpg"
import companyLogo2 from "/img-admin/company-logo-2.jpg"
import companyLogo3 from "/img-admin/company-logo-3.jpg"
import companyLogo4 from "/img-admin/company-logo-4.jpg"
import companyLogo5 from "/img-admin/company-logo-5.jpg"
import companyLogo6 from "/img-admin/company-logo-6.jpg"
import companyLogo7 from "/img-admin/company-logo-7.jpg"
                        ...
                        <div className="company-section">
                            ...
                            <div className="task__list">
                                <div className="task__list-item">
                                    <div className="logo">
                                        <img width="102" height="68" src={companyLogo1} alt=""/>
                                    </div>
                                    <div className="info">
                                        <h4>Asana</h4>
                                        <p>
                                ...
                                <div className="task__list-item">
                                    <div className="logo">
                                        <img width="73" height="72" src={companyLogo2} alt=""/>
                                    </div>
                                    <div className="info">
                                        <h4>Jira</h4>
                                        <p>
                                ...
                                <div className="task__list-item">
                                    <div className="logo">
                                        <img width="217" height="35" src={companyLogo3} alt=""/>
                                    </div>
                                    <div className="info">
                                        <h4>Clubhouse</h4>
                                        <p>
                                ...
                                <div className="task__list-item">
                                    <div className="logo">
                                        <img width="192" height="44" src={companyLogo4} alt=""/>
                                    </div>
                                    <div className="info">
                                        <h4>Monday</h4>
                                        <p>
                                ...
                                <div className="task__list-item">
                                    <div className="logo">
                                        <img width="133" height="44" src={companyLogo5} alt=""/>
                                    </div>
                                    <div className="info">
                                        <h4>Trello</h4>
                                        <p>
