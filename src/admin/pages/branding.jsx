...
import uploadLogo from "/img-admin/upload-logo.svg"
import illustractionImg1 from "/img-admin/illustration-1.jpg"
import illustractionImg2 from "/img-admin/illustration-2.jpg"
import illustractionImg3 from "/img-admin/illustration-3.jpg"
                    ...
                    <section className="content">
                            ...
                            <div className="content__block upload">
                                <form action="#">
                                    <div className="upload__heading">
                                        <img className="logo" src={uploadLogo} alt=""/>
                                ...
                                <div className="upload__info">
                                    ...
                                    <img className="illustration" src={illustractionImg1} alt=""/>
                                    <div className="illustration-info">
                                        Here you can replace the logo with your own
                                    </div>
                                    <img className="illustration" src={illustractionImg2} alt=""/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="content__section">
                            ...
                            <div className="content__block">
                                ...
                                <img className="illustration" src={illustractionImg3} alt=""/>
                            </div>
                        </div>
                    </section>
                </section>
